  ...
  return (
    <>
      <Typography>
        ...
        <Paragraph>
          上传js-question题库，文件格式为json，题目暂时只支持单选题。具体格式如上的代码所示。
        </Paragraph>
        ...
        及<Text code>__typename</Text>属性。除<Text code>options</Text>外都为字符串类型。<Text code>code</Text>属性会交由code mirror进行渲染。而<Text code>options</Text>为选项数组，<Text code>text</Text>为选项内容，<Text code>correct</Text>为选项正确性，格式为布尔值。
        </Paragraph>
